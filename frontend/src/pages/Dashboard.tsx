      ...
      {loading ? (
        ...
        <>
          ...
          {(summary.overdue_count > 0 || summary.due_today_count > 0) && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {summary.overdue_count > 0 && (
                <div className="flex items-center justify-between p-4 bg-rose-50 dark:bg-rose-950/30 border border-rose-200 dark:border-rose-900/50 rounded-2xl">
              ...
              {summary.due_today_count > 0 && (
                <div className="flex items-center justify-between p-4 bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-900/50 rounded-2xl">
                  <div className="flex items-center gap-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div className="bg-gradient-to-br from-zinc-900 to-zinc-800 dark:from-zinc-900 dark:to-zinc-950 border border-zinc-800 text-white rounded-2xl p-5 shadow-md space-y-3">
              <div className="flex items-center justify-between">
